...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Bootstrap weighted judge ensemble weights.")
...
def main() -> None:
    ...
    print(f"wrote bootstrap outputs to {summary['out_dir']}")
    print(f"bootstrap replicates: {summary['n_bootstrap']}; judges: {summary['n_judges']}")
